...
% FEM_20220901.m
%
% Model exported on Sep 1 2022, 16:04 by COMSOL 6.0.0.318.
...
model.modelPath('R:\Computational Modeling\Example FEM as of 20220628');
...
model.component('comp1').geom('geom1').feature('sel1').label('Facial Input');
...
model.component('comp1').material('mat1').selection.named('geom1_imp1_Vestibular_Nerve1_dom');
model.component('comp1').material('mat1').selection.named('geom1_imp1_Cochlear_Nerve1_dom');
...
model.component('comp1').material('mat1').selection.set([5 11 16 17 18 19 20]);
...
model.component('comp1').material('mat2').selection.named('geom1_imp1_lumen1_dom');
...
model.component('comp1').material('mat2').selection.named('geom1_imp1_electrodes1_1_dom');
model.component('comp1').material('mat2').selection.named('geom1_imp1_electrodes1_2_dom');
model.component('comp1').material('mat2').selection.named('geom1_imp1_lumen1_dom');
...
model.component('comp1').material('mat2').selection.set([6 7 9 10 12 13 14 15]);
...
model.component('comp1').material('mat6').selection.set([4]);
...
% have to specify data to output in each file
model.result.export.create('data1', 'Data');
model.result.export('data1').label('Facial CC');
model.result.export('data1').set('filename', 'R:\Computational Modeling\Example FEM as of 20220628\Facial_cc_out.txt');
model.result.export.create('data2', 'Data');
model.result.export('data2').label('Cochlear CC');
model.result.export('data2').set('filename', 'R:\Computational Modeling\Example FEM as of 20220628\Cochlear_cc_out.txt');
model.result.export.create('data3', 'Data');
model.result.export('data3').set('filename', 'R:\Computational Modeling\Example FEM as of 20220628\Vestibular_cc_out.txt');
model.result.export('data3').label('Vestibular CC');
model.result.export.create('data4', 'Data');
model.result.export('data2').set('data', 'dset2');
model.result.export('data3').set('data', 'dset3');
model.result.export('data4').set('data', 'dset4');
model.result.export('data4').label('Electric Currents');
model.result.export('data4').set('expr', {'V'});
model.result.export('data4').set('descr', {'Electric potential'});
model.result.export('data4').set('expr', {'V' 'ec.Ex' 'ec.Ey' 'ec.Ez'});

model.label('FEM 20220901.mph');
