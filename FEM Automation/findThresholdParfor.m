...
%     ph{6} = plot(currVector,  facSumNorm{el2TileMap(i)}, ':','LineWidth',1); 
    ph{7} = plot(currVector,  cochSumNorm{el2TileMap(i)}, ':','LineWidth',1);
...
legend([ph{1} ph{2} ph{3} ph{4} ph{5} ph{7}], nerve_names([1:5 7]),'Location','northwest','NumColumns',2) % apply legend to last plot
legend('boxoff')
