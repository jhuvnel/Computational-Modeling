...
num_n = 19;    %number of nodes
nd = 2.81e-6;     %node diameter
Ve = LP_IrrAff_mean;
axon = G_AHPAxon_CVStar5082([151e-6; 150.5e-6; -1], [nd; -1],[2e-6;1e-6;-1], [300e-6;-1], num_n, dt, num_dt);
%CHANGE BELOW TOO!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
lt = temp2(find(temp2<500));
dp = temp3(find(temp3>0.002));
for iterator = 1:9
    axon = G_AHPAxon_CVStar5082([151e-6; 150.5e-6; -1], [nd; -1],[2e-6;1e-6;-1], [300e-6;-1], num_n, dt, num_dt);
    R = Axon.quickSimulate(axon, num_dt, Ve, waveForm);
    intS = find(R == 1);
    ...
    lt = [lt; temp2(find(temp2<500))];
    dp = [dp; temp3(find(temp3>0.002))];
end
