/*  This class is a modfied version of the Frijns sodium channel, it is used
 * to allow for easier action potential initiation for the goldberg channel,
 * primarily h has been changed
 */
...
public class G_SodiumChannel extends Channel implements GlobalConstants {
	...
	public G_SodiumChannel(double diameter, double length, double timeIncrement) {
	...
	public static double alpha_h(double Vm)	{
		...
		return result*tempA_h;				//temp correction and correction to allow for easier APs
	}
