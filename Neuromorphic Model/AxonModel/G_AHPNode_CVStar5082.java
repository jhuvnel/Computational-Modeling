...
class G_AHPNode_CVStar5082 extends Node {
	...
	public double returnTest()	{
		...
		result = ((G_AHPChannel_CVStar5082)channel_G).test;
		return result;
	}


	public G_AHPNode_CVStar5082(double diam, double len, double t_increment, PrintWriter errorLog) {
