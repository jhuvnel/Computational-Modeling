 ...
 * presented here are for a node diameter of 1.4e-6m, and a node length of 2e-6m
 */

import java.util.Arrays;
import static java.lang.Math.*;

public class G_AHPChannel_CVStar0265 extends Channel implements GlobalConstants {
	...
	public double gs = 0.45; //0.64 for nodeLen = 1um			//gs = strength of synaptic noise (roughly based off of "A" from smith/goldberg paper)
	//need to get gk0 in terns of unit area also
	public double gk0 = 1600;			//constant term for hyperpolarizing potassium current
	public double gk = 1600;	//1700 for nodeLen = 1um		//holds the current value of gk
	public double prev_gk = 0;		//stored value of a previous value of gk
	public double tk = 0.00707;			//hyperpolarizing current time constant in seconds (from smith/goldberg paper)
	...
	public double shotNoiseInit = 100;	//what to initialize the shot noise memory too

	//for testing
	public double test;
	
	public G_AHPChannel_CVStar0265(double diameter, double length,
	...
	public int findPoisson(double r)	{
		int result;
		result = Arrays.binarySearch(PoissonDistribution.pD_lam1250_dTpt1ms, r);
