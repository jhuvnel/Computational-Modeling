...
horSCC_SimCell{2} = simulateWaveform(parameterCellSCC_3to5,horSCC_PE1_LI3to5_SolutionCell,waveForm, traj, simClass2,0);
clear simClass2;
clear traj;
load('MRIFE_HorSCC_100Traj_LocInd_5to8.mat');
traj = traj(1:(size(traj,1)/2),:);
simClass3 = AxonSimulate_G_AHPAxon_CVStar1483();
horSCC_SimCell{3} = simulateWaveform(parameterCellSCC_5to8,horSCC_PE1_LI5to8_SolutionCell,waveForm, traj, simClass3,0);
clear simClass3;
clear traj;
load('MRIFE_HorSCC_110Traj_LocInd_6to10.mat');
traj = traj(1:(size(traj,1)/2),:);
simClass4 = AxonSimulate_G_AHPAxon_CVStar5082();
horSCC_SimCell{4} = simulateWaveform(parameterCellSCC_6to10,horSCC_PE1_LI6to10_SolutionCell,waveForm, traj,simClass4,0);
clear simClass4;
clear traj;
...
horSCC_SimCell{5} = simulateWaveform(parameterCellSCC_2to5,horSCC_PE1_LI2to5_SolutionCell,waveForm,traj,simClass5,0);
clear simClass5;
clear traj;
load('MRIFE_HorSCC_300Traj_LocInd_4to7.mat');
traj = traj(1:(size(traj,1)/2),:);
simClass6 = AxonSimulate_G_AHPAxon_CVStar1483();
horSCC_SimCell{6} = simulateWaveform(parameterCellSCC_4to7,horSCC_PE1_LI4to7_SolutionCell,waveForm,traj,simClass6,0);
clear simClass6;
clear traj;
...
posSCC_SimCell{1} = simulateWaveform(parameterCellSCC_1to3,posSCC_PE1_LI1to3_SolutionCell,waveForm,traj,simClass7,0);
clear simClass7;
clear traj;
load('MRIFE_PosSCC_100Traj_LocInd_3to5.mat');
traj = traj(1:(size(traj,1)/2),:);
simClass8 = AxonSimulate_G_AHPAxon_CVStar0265();
posSCC_SimCell{2} = simulateWaveform(parameterCellSCC_3to5,posSCC_PE1_LI3to5_SolutionCell,waveForm,traj,simClass8,0);
clear simClass8;
clear traj;
load('MRIFE_PosSCC_100Traj_LocInd_5to8.mat');
traj = traj(1:(size(traj,1)/2),:);
simClass9 = AxonSimulate_G_AHPAxon_CVStar1483();
posSCC_SimCell{3} = simulateWaveform(parameterCellSCC_5to8,posSCC_PE1_LI5to8_SolutionCell,waveForm,traj,simClass9,0);
clear simClass9;
clear traj;
load('MRIFE_PosSCC_110Traj_LocInd_6to10.mat');
traj = traj(1:(size(traj,1)/2),:);
simClass10 = AxonSimulate_G_AHPAxon_CVStar5082();
posSCC_SimCell{4} = simulateWaveform(parameterCellSCC_6to10,posSCC_PE1_LI6to10_SolutionCell,waveForm,traj,simClass10,0);
clear simClass10;
clear traj;
...
posSCC_SimCell{5} = simulateWaveform(parameterCellSCC_2to5,posSCC_PE1_LI2to5_SolutionCell,waveForm,traj,simClass11,0);
clear simClass11;
clear traj;
load('MRIFE_PosSCC_300Traj_LocInd_4to7.mat');
traj = traj(1:(size(traj,1)/2),:);
simClass12 = AxonSimulate_G_AHPAxon_CVStar1483();
posSCC_SimCell{6} = simulateWaveform(parameterCellSCC_4to7,posSCC_PE1_LI4to7_SolutionCell,waveForm,traj,simClass12,0);
clear simClass12;
clear traj;
...
supSCC_SimCell{1} = simulateWaveform(parameterCellSCC_1to3,supSCC_PE1_LI1to3_SolutionCell,waveForm,traj,simClass13,0);
clear simClass13;
clear traj;
load('MRIFE_SupSCC_100Traj_LocInd_3to5.mat');
traj = traj(1:(size(traj,1)/2),:);
simClass14 = AxonSimulate_G_AHPAxon_CVStar0265();
supSCC_SimCell{2} = simulateWaveform(parameterCellSCC_3to5,supSCC_PE1_LI3to5_SolutionCell,waveForm,traj,simClass14,0);
clear simClass14;
clear traj;
load('MRIFE_SupSCC_100Traj_LocInd_5to8.mat');
traj = traj(1:(size(traj,1)/2),:);
simClass15 = AxonSimulate_G_AHPAxon_CVStar1483();
supSCC_SimCell{3} = simulateWaveform(parameterCellSCC_5to8,supSCC_PE1_LI5to8_SolutionCell,waveForm,traj,simClass15,0);
clear simClass15;
clear traj;
load('MRIFE_SupSCC_110Traj_LocInd_6to10.mat');
traj = traj(1:(size(traj,1)/2),:);
simClass16 = AxonSimulate_G_AHPAxon_CVStar5082();
supSCC_SimCell{4} = simulateWaveform(parameterCellSCC_6to10,supSCC_PE1_LI6to10_SolutionCell,waveForm,traj,simClass16,0);
clear simClass16;
clear traj;
...
supSCC_SimCell{5} = simulateWaveform(parameterCellSCC_2to5,supSCC_PE1_LI2to5_SolutionCell,waveForm,traj,simClass17,0);
clear simClass17;
clear traj;
load('MRIFE_SupSCC_300Traj_LocInd_4to7.mat');
traj = traj(1:(size(traj,1)/2),:);
simClass18 = AxonSimulate_G_AHPAxon_CVStar1483();
supSCC_SimCell{6} = simulateWaveform(parameterCellSCC_4to7,supSCC_PE1_LI4to7_SolutionCell,waveForm,traj,simClass18,0);
clear simClass18;
clear traj;
save 'AllDone'
