...
parameterCellSCC_1to3{1} = 1;
parameterCellSCC_2to5{1} = 1;
parameterCellSCC_3to5{1} = 1;
parameterCellSCC_4to7{1} = 1;
parameterCellSCC_5to8{1} = 1;
parameterCellSCC_6to10{1} = 1;
%parameterCellSCC_1to3{3} = [1e-6;-1];
%parameterCellSCC_2to5{3} = [1e-6;-1];
%parameterCellSCC_3to5{3} = [1e-6;-1];
%parameterCellSCC_4to7{3} = [1e-6;-1];
%parameterCellSCC_5to8{3} = [1e-6;-1];
%parameterCellSCC_6to10{3} = [1e-6;-1];
...
traj = traj(1:10,:);
simClass1 = AxonSimulate_SENN_AxonI();%AxonSimulate_G_AHPAxon_CVStar0265();
...
traj = traj(1:10,:);
simClass2 = AxonSimulate_SENN_AxonI();%AxonSimulate_G_AHPAxon_CVStar0265();
...
traj = traj(1:10,:);
simClass3 = AxonSimulate_SENN_AxonI();%AxonSimulate_G_AHPAxon_CVStar1483();
...
traj = traj(1:10,:);
simClass4 = AxonSimulate_SENN_AxonI();%AxonSimulate_G_AHPAxon_CVStar5082();
...
traj = traj(1:10,:);
simClass5 = AxonSimulate_SENN_AxonI();%AxonSimulate_G_AHPAxon_CVStar1483();
...
traj = traj(1:10,:);
simClass6 = AxonSimulate_SENN_AxonI();%AxonSimulate_G_AHPAxon_CVStar1483();
...
traj = traj(1:10,:);
simClass7 = AxonSimulate_SENN_AxonI();%AxonSimulate_G_AHPAxon_CVStar0265();
...
traj = traj(1:10,:);
simClass8 = AxonSimulate_SENN_AxonI();%AxonSimulate_G_AHPAxon_CVStar0265();
...
traj = traj(1:10,:);
simClass9 = AxonSimulate_SENN_AxonI();%AxonSimulate_G_AHPAxon_CVStar1483();
...
traj = traj(1:10,:);
simClass10 = AxonSimulate_SENN_AxonI();%AxonSimulate_G_AHPAxon_CVStar5082();
...
simClass11 = AxonSimulate_SENN_AxonI();%AxonSimulate_G_AHPAxon_CVStar1483();
...
traj = traj(1:10,:);
simClass12 = AxonSimulate_SENN_AxonI();%AxonSimulate_G_AHPAxon_CVStar1483();
...
traj = traj(1:10,:);
simClass13 = AxonSimulate_SENN_AxonI();%AxonSimulate_G_AHPAxon_CVStar0265();
...
traj = traj(1:10,:);
simClass14 = AxonSimulate_SENN_AxonI();%AxonSimulate_G_AHPAxon_CVStar0265();
...
traj = traj(1:10,:);
simClass15 = AxonSimulate_SENN_AxonI();%AxonSimulate_G_AHPAxon_CVStar1483();
...
traj = traj(1:10,:);
simClass16 = AxonSimulate_SENN_AxonI();%AxonSimulate_G_AHPAxon_CVStar5082();
...
traj = traj(1:10,:);
simClass17 = AxonSimulate_SENN_AxonI();%AxonSimulate_SENN_AxonI();
...
traj = traj(1:10,:);
simClass18 = AxonSimulate_SENN_AxonI();%AxonSimulate_SENN_AxonI();
