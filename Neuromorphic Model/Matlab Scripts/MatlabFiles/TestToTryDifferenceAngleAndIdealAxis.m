...
%    ExpVector = ExpVector/norm(ExpVector);
   ...
   SimVectorM=m*SimVector;
    ...
    error = dot(SimVector, LAnormal); error = acos(error); tableerror(i) =  error*(180/pi);
    error2 = dot(SimVectorM, LAnormal); error2 = acos(error2); tableerror2(i) =  error2*(180/pi);
    error3 = dot(SimVectorM, SimVector);error3 = acos(error3);tableerror3(i) =  error3*(180/pi);
    %error = acos(error);
    %error =  error*(180/pi)
...
%    ExpVector = ExpVector/norm(ExpVector);
   ...
   SimVectorM=m*SimVector;
    ...
    error = dot(SimVector, LPnormal); error = acos(error); tableerror(i) =  error*(180/pi);
    error2 = dot(SimVectorM, LPnormal); error2 = acos(error2); tableerror2(i) =  error2*(180/pi);
    error3 = dot(SimVectorM, SimVector);error3 = acos(error3);tableerror3(i) =  error3*(180/pi);
    %error = acos(error);
    %error =  error*(180/pi)
