...
subplot(3,5,1)
    ...
    SpuriousActivationError(VectorSum,1)
        cd 'R:\VNEL Alumni Files\Olds-Kevin';
...
load('Workspace Electrode_Horizontal2_comsol_common_cruz_sim12.mat')
subplot(3,5,3)
    cd 'R:\VNEL Alumni Files\Olds-Kevin\WORKING COPY\Current Code as of 08-10-07\Matlab Scripts';run ThresholdPostProcAbder;  ;
...
load('Workspace Electrode_Superior2_comsol_common_cruz_sim12.mat')
subplot(3,5,8)
    cd 'R:\VNEL Alumni Files\Olds-Kevin\WORKING COPY\Current Code as of 08-10-07\Matlab Scripts';run ThresholdPostProcAbder;  ;
...
load('Workspace Electrode_Posterior2_comsol_common_cruz_sim12.mat')
subplot(3,5,13)
 cd 'R:\VNEL Alumni Files\Olds-Kevin\WORKING COPY\Current Code as of 08-10-07\Matlab Scripts';run ThresholdPostProcAbder;  ;
        cd 'R:\VNEL Alumni Files\Olds-Kevin';
