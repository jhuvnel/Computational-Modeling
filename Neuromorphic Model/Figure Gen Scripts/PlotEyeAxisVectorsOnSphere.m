%plotChoose = 'LH' or 'LP' or 'LA'
function y = PlotEyeAxisVectorsOnSphere(vectorExp, vectorSim)

%originally adapted from plotgeorgeCDS.m
%
...
NormalsNames= [''      ' +Y'     ' +Z'     '+LA'      '+LH'     '+LP'      '-RA'    '-RH'    '-RP'];
MeanAllnormals =  [       0        0        0      -0.49122   -0.80631  -0.32283  0.488716   0.818676   0.311848;...
