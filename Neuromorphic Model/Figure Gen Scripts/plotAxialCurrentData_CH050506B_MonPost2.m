...
load ch050506B_MonPost2_7200B7000N_DAniso2_AxialCurrent
AxialCurrentFlowAndStandardDev;
title('Ch050506B MonPost2 vs e1ve6 200uS210uA, LH=red,LA=green,LP=blue');
figure;
...
load ch050506B_MonPost2_7200B7000N_DAniso2_AxialCurrent
AxialCurrentFlowAndStandardDev;
title('Ch050506B MonPost2 vs e0ve7 200uS50uA, LH=red,LA=green,LP=blue');
figure;
...
load ch050506B_MonPost2_7200B7000N_DAniso2_AxialCurrent
AxialCurrentFlowAndStandardDev;
title('Ch050506B MonPost2 vs e0ve7 200uS100uA, LH=red,LA=green,LP=blue');
figure;
...
load ch050506B_MonPost2_7200B7000N_DAniso2_AxialCurrent
AxialCurrentFlowAndStandardDev;
title('Ch050506B MonPost2 vs e0ve7 200uS120uA, LH=red,LA=green,LP=blue');
figure;
...
load ch050506B_MonPost2_7200B7000N_DAniso2_AxialCurrent
AxialCurrentFlowAndStandardDev;
title('Ch050506B MonPost2 vs e0ve7 200uS150uA, LH=red,LA=green,LP=blue');
figure;
...
load ch050506B_MonPost2_7200B7000N_DAniso2_AxialCurrent
AxialCurrentFlowAndStandardDev;
title('Ch050506B MonPost2 vs e0ve7 200uS200uA, LH=red,LA=green,LP=blue');
figure;
